...
import com.scenekey.lib_sources.arc_menu.anim.AnimationObject;
import com.scenekey.lib_sources.arc_menu.anim.ViewAnim;
import com.scenekey.lib_sources.arc_menu.util.AbsListViewScrollDetector;
import com.scenekey.lib_sources.arc_menu.util.ScrollDirectionListener;
import com.scenekey.lib_sources.arc_menu.util.Util;
import com.scenekey.lib_sources.arc_menu.widget.ArcLayout;
...
public class ArcMenu extends RelativeLayout {
        ...
        if (attrs != null) {
            ...
            switch (mType) {
                ...
                case TYPE_NORMAL:
                    ...
                    break;
                case TYPE_MINI:
                    defaultMenuSize = getResources().getDimensionPixelSize(R.dimen.fab_size_mini2);
                    break;
                default:
                    defaultMenuSize = getResources().getDimensionPixelSize(R.dimen.fab_size_normal2);
            }
    ...
    private TextView getContentView(String str) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            textView.setBackground(getResources().getDrawable(R.drawable.bg_round_primary_border));
        } else {
            //noinspection deprecation
            textView.setBackgroundDrawable(getResources().getDrawable(R.drawable.bg_round_primary_border));
        }
