...
public class SwipeCardView extends BaseFlingAdapterView {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        Log.e("Count", "SwipeCardView " + currentAdapterCount + " :Start " + START_STACK_FROM + "adpterCount" + adapterCount + " LastCount" + LAST_OBJECT_IN_STACK);
    ...
    private void layoutChildren(int startingIndex, int adapterCount) {
        Log.e("Layout Childern", "startingINdex" + startingIndex + " : " + adapterCount + " LastCount" + LAST_OBJECT_IN_STACK + " CC" + currentAdapterCount);
        resetOffsets();
