...
public class SwipeCardView extends BaseFlingAdapterView {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        // Util.printLog("Count", "SwipeCardView " + currentAdapterCount + " :Start " + START_STACK_FROM + "adpterCount" + adapterCount + " LastCount" + LAST_OBJECT_IN_STACK);
    ...
    private void layoutChildren(int startingIndex, int adapterCount) {
        // Util.printLog("Layout Childern", "startingINdex" + startingIndex + " : " + adapterCount + " LastCount" + LAST_OBJECT_IN_STACK + " CC" + currentAdapterCount);
        resetOffsets();
