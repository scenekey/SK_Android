...
public abstract class Pop_Up_Option extends Dialog {
    ...
    public Pop_Up_Option(@NonNull Context context) {
        ...
        View pop_up_view = LayoutInflater.from(context).inflate(R.layout.popup_custom_menu, null);

        ImageView tv_cancel = pop_up_view.findViewById(R.id.tv_cancel);
        ImageView tv_gallery = pop_up_view.findViewById(R.id.tv_gallery);
        ImageView tv_camera = pop_up_view.findViewById(R.id.tv_camera);
        ...
        lp.width    = (int) context.getResources().getDimension(R.dimen._250sdp);
        lp.height   = (int) context.getResources().getDimension(R.dimen._122sdp);
