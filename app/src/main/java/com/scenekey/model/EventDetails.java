...
public class EventDetails {
   ...
   private String nudges_count;
    ...
    public void setFeedsJson(JSONArray Json,Event_Fragment fragment) throws JSONException {
        fragment.cardsList.clear();
    ...
    public void setProfile_ratingJSon(JSONObject JSon,Event_Fragment fragment) throws JSONException {
        ...
        if (JSon.has("like")) {
            ...
            if (profile_rating.getLike().equals("1")) {
                fragment.fabMenu1_like.setImageDrawable(fragment.getActivity().getResources().getDrawable(R.drawable.red_heart));
            }
        }
