...
public class ImageUtil {
    ...
    public static File saveToInternalfile(Bitmap bitmapImage, Context context) {
        ContextWrapper cw = new ContextWrapper(context);
        // path to /data/data/yourapp/app_data/imageDir
        File directory = cw.getDir("imageDir", Context.MODE_PRIVATE);
        // Create imageDir
        ...
        try {
            fos = new FileOutputStream(mypath);
            // Use the compress method on the BitMap object to write image to the OutputStream
           if(bitmapImage.getWidth()>512){
               int nh = (int) ( bitmapImage.getHeight() * (512.0 / bitmapImage.getWidth()) );
                bitmapImage =   Bitmap.createScaledBitmap(bitmapImage, 512, nh, true);
           }
    ...
    public static File saveToInternalfileDatename(Bitmap bitmapImage, Context context) {
        ContextWrapper cw = new ContextWrapper(context);
        // path to /data/data/yourapp/app_data/imageDir
        File directory = cw.getDir("imageDir", Context.MODE_PRIVATE);
        // Create imageDir
        File mypath = new File(directory, "IMG-"+(new SimpleDateFormat("HHmmss_yyyyMMdd")).format(new Date())+".jpg");
    ...
    public static void saveImageFromBitmap(Bitmap bitmap, Context context) {
        ...
        try {
            ...
            /**/// Util.printLog("SAVE_IMAGE", e.getMessage(), e);
        }
    }
    ...
    public static Bitmap adjustImageOrientation(Bitmap image , String picturePath) {
        ...
        try {
            ...
            int rotate = 0;
            Utility.e("Rotation",exifOrientation+"");
